...
const Section5: React.FC = () => { 
    return (
        ...
        <motion.div className="text-container"
            ...
            <p className="section-3-text">As the portfolio work listed here shows, I can write in a variety of common web languages. I'm capable of designing, developing and deploying performant, interactive, dynamic, content-rich and data-driven web applications. Wether working with vanilla HTML, CSS and JavaScript, or taking advantage of libraries and frameworks I have the ability to construct performant and visually appealing applications to suit the needs of any business operation.</p>
          </motion.div>  
